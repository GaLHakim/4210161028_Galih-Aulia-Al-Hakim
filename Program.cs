...
namespace ConsoleApp2
{
    ...
    public class byteData
    {
        ...
        {
            //membungkus data yang akan dikirim
        ...
        {
            //membongkar data yang diterima dari client
    ...
    class Server
    {
        ...
        //const string SERVER_IP = "192.168.43.1";
        ...
        public static void Start()
        {
            ...
            using (NetworkStream nwStream = client.GetStream())
            {
                ...
                dataEnemy.Show();
                //setelah dibongkar dimasukkan lagi dan dikirim berupa byte
    ...
    {
        const int PORT_NO = 8888;
        const string CLIENT_IP = "192.168.43.1";
